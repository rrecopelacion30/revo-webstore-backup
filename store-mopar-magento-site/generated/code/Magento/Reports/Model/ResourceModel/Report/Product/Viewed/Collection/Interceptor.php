...
class Interceptor extends \Magento\Reports\Model\ResourceModel\Report\Product\Viewed\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function getTableByAggregationPeriod($period)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getTableByAggregationPeriod', func_get_args(), $pluginInfo) : parent::getTableByAggregationPeriod($period);
    }
    ...
    public function addStoreRestrictions($storeIds)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStoreRestrictions', func_get_args(), $pluginInfo) : parent::addStoreRestrictions($storeIds);
    }
