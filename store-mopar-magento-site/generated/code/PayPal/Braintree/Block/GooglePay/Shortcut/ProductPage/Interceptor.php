...
class Interceptor extends \PayPal\Braintree\Block\GooglePay\Shortcut\ProductPage implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'isProductVirtual');
        return $pluginInfo ? $this->___callPlugins('isProductVirtual', func_get_args(), $pluginInfo) : parent::isProductVirtual();
    }
    ...
    public function getAvailableCardTypes(): array
    {
        ...
        return $pluginInfo ? $this->___callPlugins('getAvailableCardTypes', func_get_args(), $pluginInfo) : parent::getAvailableCardTypes();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getBtnColor');
        return $pluginInfo ? $this->___callPlugins('getBtnColor', func_get_args(), $pluginInfo) : parent::getBtnColor();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'get3DSecureConfigData');
        return $pluginInfo ? $this->___callPlugins('get3DSecureConfigData', func_get_args(), $pluginInfo) : parent::get3DSecureConfigData();
    }
    ...
    public function priceIncludesTax(): bool
    {
        ...
        return $pluginInfo ? $this->___callPlugins('priceIncludesTax', func_get_args(), $pluginInfo) : parent::priceIncludesTax();
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getMultiCouponLimit');
        return $pluginInfo ? $this->___callPlugins('getMultiCouponLimit', func_get_args(), $pluginInfo) : parent::getMultiCouponLimit();
    }
